...
describe('ClientDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'client-details', component: ClientDetailsComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
