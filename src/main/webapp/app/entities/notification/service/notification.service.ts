...
export class NotificationService {
  ...
  update(notification: INotification): Observable<EntityResponseType> {
    return this.http.put<INotification>(`${this.resourceUrl}/${getNotificationIdentifier(notification) as number}`, notification, {
      observe: 'response',
    });
  }

  partialUpdate(notification: INotification): Observable<EntityResponseType> {
    return this.http.patch<INotification>(`${this.resourceUrl}/${getNotificationIdentifier(notification) as number}`, notification, {
      observe: 'response',
    });
  }
